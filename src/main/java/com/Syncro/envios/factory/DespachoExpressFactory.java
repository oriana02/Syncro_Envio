...
/**
 * Fabrica concreta para envios de tipo EXPRESS.
 * Tiempo estimado: 24 horas habiles.
 * Costo base: $7.990
 */
@Component
public class DespachoExpressFactory implements DespachoFactory {

    private static final String TIPO = "EXPRESS";
    private static final BigDecimal COSTO_BASE = new BigDecimal("7990");
